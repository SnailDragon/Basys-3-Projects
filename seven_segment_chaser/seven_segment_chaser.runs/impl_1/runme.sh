...
HD_PWD='C:/Users/tyler/Documents/Basys-3-Projects/seven_segment_chaser/seven_segment_chaser.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segment_chaser.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seven_segment_chaser.tcl -notrace
